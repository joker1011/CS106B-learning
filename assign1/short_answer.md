...
**<font size=4>A10.</font>**　　

|  步骤  | 步骤描述 |　编码　|
| :--: | :--: | :--: |
| １ | 去除所有非字母字符：横线、空格、标点等　| Angelou |
| ２ | 根据表编码每个字母 |　0520400 |
| ３ | 从得到的编码中，合并相邻的重复数字 | 052040 |
| ４ | 使用姓氏名的第一个字母替换第一个数字，并转换为大写形式 | A52040 |
|　5 | 删除编码中所有的数字 0 | A524 |
|　6 | 通过填充 0 或截掉多余部分，使得编码长度恰好为 4 | A524 |



### 💡Q11. 在写代码之前，自行进行头脑风暴，尝试把这个任务分解成几个小任务。简单描述一下你的分解过程。

**<font size=4>A11.</font>**　　
|  步骤  | 步骤描述 |　函数名　|
| :--: | :--: | :--: |
| １ | 去除所有非字母字符：横线、空格、标点等　| removeNonLetters(),  isAlpha() |
| ２ | 根据表编码每个字母 | soundexEncode(), toUppercase() |
| ３ | 从得到的编码中，合并相邻的重复数字 | removeDuplicates() |
| ４ | 使用姓氏名的第一个字母替换第一个数字，并转换为大写形式 | 没必要专门写一个函数   |
|　5 | 删除编码中所有的数字 0 | A524 | removeCertainCharacter() |
|　6 | 通过填充 0 或截掉多余部分，使得编码长度恰好为 4 | soundexCodeCompletion() |



### 💡补充1.原生的removeNonLetters函数错误在哪里

**<font size=4>A补充１.</font>**

错误原因：这里主要是把第一个字符(s[0])直接给了result，并且在下面的循环中跳过了第一个字符的检测．  
　　　　　也就是说如果输入的字符串第一个字符不是字母它是检测不到的.  
　
**<font size=4>修改后的removeNonLetters代码</font>**
```asm
...
**<font size=4>A补充２．</font>**  
![](res/补充2soundexSearch results.png)

### 💡补充3.所有Ｐrovided_test结果
**<font size=4>A补充３．</font>**　　
![](res/补充3All provided_test results.png)
